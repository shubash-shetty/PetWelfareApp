...
public class AdoptPet extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setNavigationItemSelectedListener((menuItem) -> {
            ...
            {
                case R.id.nav_home:
                    Intent intent=new Intent(AdoptPet.this,Dashboard.class);
                    startActivity(intent);
                    break;

                case R.id.nav_addpet:
                    Intent intent1=new Intent(AdoptPet.this,AddPet.class);
                    startActivity(intent1);
                    break;

                case R.id.nav_logout:
                    Intent intent2=new Intent(AdoptPet.this,MainActivity.class);
        ...
        studentAdapter=new StudentAdapter(AdoptPet.this,studentModelList);
