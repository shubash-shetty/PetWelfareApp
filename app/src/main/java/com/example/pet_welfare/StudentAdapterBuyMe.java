...
public class StudentAdapterBuyMe extends RecyclerView.Adapter<StudentAdapterBuyMe.ViewHolder> {
    Context context;
    ...
    public StudentAdapterBuyMe(Context context, List<StudentModel> studentModelList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        holder.name.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(holder.name.getContext(),targetbuy.class);
